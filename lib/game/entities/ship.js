...
requires('impact.entity', 'game.entities.particle').defines(function ()
{
    EntityShip = ig.Entity.extend(
    {
        ...
        animSheet: new ig.AnimationSheet('media/ship_02.png', 102, 83),
        ...
        init: function (x, y, settings)
        {
            ...
            this.shootTimer = new ig.Timer(Math.random() * 1.5);
...
*/
          ...
          //  ig.game.spawnEntity(EntityFroskShot, this.pos.x + 4, this.pos.y + 4);
            ig.game.spawnEntity(EntityShipLaser, this.pos.x, this.pos.y, {
                    flip: this.flip
                });

            this.shootTimer.set(Math.random() * 1.5)
            }
 ...
 EntityShipLaser = ig.Entity.extend(
    {
        ...
        hasHit: false,
        lifetime: 2,
        animSheet: new ig.AnimationSheet('media/vw/laserbeam_green_vert.png', 4, 34),
        init: function (x, y, settings)
        {
            this.parent(x, y, settings);
            this.vel.x=0
