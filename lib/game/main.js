...
MyGame = ig.Game.extend({
    ...
    init: function() {
            ...
            this.camera.lookAhead.x = ig.ua.mobile ? ig.system.width / 10 : 0;
    ...
    draw: function() {
        ...
        //    this.font.draw( 'SCORE: '+ig.game.score+" GAS: "+ig.game.jetGas+" LIVES: "+ig.game.livesLeft, 2, 2 );
            this.font.draw('HIGHSCORE: '+this.storage.getInt('jmhighScore'),(ig.system.width/2),2);
        }  
...
if( ig.ua.iPad ) {
    ...
    if (ig.ua.iPad)
        ...
        else
        {
            ...
            ig.Sound.enabled = false;
            ig.main('#canvas', GameTitle, 60, 980, 600, 1, ig.ImpactSplashLoader);
        }
